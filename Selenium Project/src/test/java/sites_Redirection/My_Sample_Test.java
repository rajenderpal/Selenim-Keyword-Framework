...
import dataUtility.Data_Utility;
import dataUtility.Xls_Reader;
import pal_Report.ExtentManager;
import pal_util.Keywords;


public class My_Sample_Test {

	ExtentReports ExtRep = null;
	ExtentTest ExtTest = null;
	Keywords TestKeywords;
	String VARIABLE_testcasename = "My_Sample_Test";
	String VARIABLE_path = System.getProperty("user.dir") + "\\Data_Sheet\\Sites_Redirects.xlsx";
...
@Test (dataProvider="getdata")
	public void Victor_Test(Hashtable <String,String> hashtable) throws InterruptedException {
